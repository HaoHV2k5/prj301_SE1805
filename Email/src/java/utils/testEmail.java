...
import static utils.Email.createHtmlRegister;
...
public class testEmail {
    ...
    private static final String password = "hbidlqbywjietaic";
    
    
    
    public static boolean createRegiter(String toEmail, String fullName, String userID) throws MessagingException{
        try {
