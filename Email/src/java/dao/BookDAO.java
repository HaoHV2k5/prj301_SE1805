...
public class BookDAO implements I_DAO<BookDTO, String>{
    ...
    public boolean create(BookDTO entity) {
        String sql = "insert into tblBooks (BookID, Title, Author,PublishYear,Price,Quantity, image) values (?,?,?,?,?,?,?)";
        ...
        try {
            ...
            ps.setInt(4, entity.getPushlistYear());
    ...
    public boolean update(BookDTO entity) {
       String sql = "update tblBooks set title = ? , author = ? , publishYear = ? , price = ?,quantity = ? , image = ? where bookID = ?";
        ...
        try {
            ...
            ps.setInt(3, entity.getPushlistYear());
