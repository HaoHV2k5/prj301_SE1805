...
public class MainController extends HttpServlet {
    ...
    private static String processEdit(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String url = "login.jsp";
    ...
    private static String processAdd(HttpServletRequest request, HttpServletResponse response)
        ...
        if (AuthUtils.isAdmin(session)) {
            ...
            try {
                ...
                BookDTO book = new BookDTO(bookID, title, author, pushlistYear, price, quantity,image);
     ...
     private static String processUpdate(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String url = "login.jsp";
